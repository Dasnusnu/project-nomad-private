...
#### Quick Install
```bash
sudo apt-get update && sudo apt-get install -y curl && curl -fsSL https://raw.githubusercontent.com/Dasnusnu/project-nomad-private/refs/heads/main/install/install_nomad.sh -o install_nomad.sh && sudo bash install_nomad.sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/Dasnusnu/project-nomad-private/refs/heads/main/install/uninstall_nomad.sh -o uninstall_nomad.sh && sudo bash uninstall_nomad.sh
```